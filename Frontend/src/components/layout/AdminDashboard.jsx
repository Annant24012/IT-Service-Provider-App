...
function AdminDashboard() {
  ...
  const fetchData = async () => {
    try {
      ...
      if (!usersResponse.ok || !messagesResponse.ok || !servicesResponse.ok) {
      ...
      console.log(usersCount, messageCount, servicesCount);
      setSummary({
      ...
      <section className="my-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            <p className="text-2xl mt-2">{summary.totalRegisteredUsers}</p>
          </Link>
          <Link
            to="/admin/contacts"
          ...
          >
            ...
            <p className="text-2xl mt-2">{summary.totalReceivedMessages}</p>
          </Link>
          <Link
            to="/admin/services"
